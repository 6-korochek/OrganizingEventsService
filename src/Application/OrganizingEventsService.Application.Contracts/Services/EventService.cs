...
public abstract class EventService
{
    ...
    public abstract void DeleteParticipantsByEmails(Guid eventId, IEnumerable<string> accountEmails);

    public abstract void DeleteParticipantByAccountId(Guid eventId, Guid accountId);

    public abstract Task<FeedbackDto> GetFeedbackInfo(Guid feedbackId);

    public abstract Task<IEnumerable<FeedbackDto>> GetFeedbacksByEventId(Guid eventId);

    public abstract Guid CreateFeedback(Guid eventId, CreateFeedbackDto createFeedbackDto);

    public abstract Task<FeedbackDto> PartiallyUpdateFeedback(Guid feedbackId, UpdateFeedbackDto updateFeedbackDto);
